...
public class SensorSimulator {
    ...
    public Location getCurrentLocation(){
        **once movement is in place, we can get the it's current coordinates**
    }
    ...
    //check whether coordinates are in the map. if not, decrement dirt, drop in the coordinates as key
    //and a 1 for visited. If the coordinates already exist, check whether visited is at 1 or 2.
